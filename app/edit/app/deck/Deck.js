define(['common/Calcium',
	...
	function(Backbone, Slide, SlideCollection, SlideCommands, CmdListFactory, key) {
		/**
		...
		return Backbone.Model.extend({
			...
			"import": function(rawObj) {
				...
				this.set("uid", rawObj.uid);
				this.set("fid", rawObj.fid);
			 ...
			 */
			create: function(index, slide) {
				this.undoHistory.pushdo(new SlideCommands.Add(this, [new Slide(slide)], index));
			},
