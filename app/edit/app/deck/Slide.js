...
define(['libs/backbone',
	...
	function(Backbone, SpatialObject, Math2, ComponentFactory, CmdListFactory, key, ComponentCommands) {
		...
		return SpatialObject.extend({
			...
			initialize: function() {
				...
				components.forEach(function(comp) {
					if (comp && comp.get('selected')) {
						this._selectionChanged(comp, true, {
							multiselect: true
						});
					}
				}, this);
