define(['libs/backbone',
		...
		'app/slideSnapshot/draw/SlideDrawer'
	],
	function(Backbone, DeckUtils, key, SlideDrawer) {
		'use strict';
		...
		return Backbone.View.extend({
			...
			initialize: function() {
				...
				this._template = JST['slideSnapshot/SlideSnapshot'];
			},
			...
			render: function() {
				...
				var $el = this.$el.find('.thumbnail');
				this._slideDrawer = new SlideDrawer(this.model, $el, {
					width: 120,
					height: 90
				});
				var self = this;
